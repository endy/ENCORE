...
public:
	...
	vector<PhotonDistPair> GetNearestNPhotons(const int N, const float maxDistance, Point3f location, Vector3f normal);
    ...
    // get the 
    Color GetRadianceEstimate(const int N, const float maxDistance, Point3f location, Vector3f normal);
